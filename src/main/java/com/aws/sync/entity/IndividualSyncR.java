...
@Data
@Table(name = "individual_sync_r")
@TableName("individual_sync_r")
@Entity
@NoArgsConstructor
@AllArgsConstructor
public class IndividualSyncR {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @TableId(type = IdType.AUTO)
    @Column(name = "individual_r_id")
    private Long individual_r_id;
    ...
    public IndividualSyncR(Long meeting_id,Double time_ms, String users, Double individual_sync, Double individual_distance, Double individual_rate) {
    ...
    public IndividualSyncR(Long meeting_id,Double time_ms, String users, Double individual_sync, Double individual_distance,Double individual_score, Double individual_rate) {
        this.meeting_id = meeting_id;
        this.time_ms = time_ms;
        this.users = users;
        this.individual_sync = individual_sync;
