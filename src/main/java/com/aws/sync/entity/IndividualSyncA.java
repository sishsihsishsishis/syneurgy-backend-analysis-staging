...
@Data
@Table(name = "individual_sync_a")
@TableName("individual_sync_a")
@Entity
@NoArgsConstructor
@AllArgsConstructor
public class IndividualSyncA {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @TableId(type = IdType.AUTO)
    @Column(name = "individual_a_id")
    private Long individual_a_id;
    ...
    public IndividualSyncA(Long meeting_id,Double time_ms, String users, Double individual_sync, Double individual_distance, Double individual_rate) {
    ...
    public IndividualSyncA(Long meeting_id,Double time_ms, String users, Double individual_sync, Double individual_distance,Double individual_score, Double individual_rate) {
        this.meeting_id = meeting_id;
        this.time_ms = time_ms;
        this.users = users;
        this.individual_sync = individual_sync;
